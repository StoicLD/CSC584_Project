...
public class InputEditor : EditorWindow
{
    ...
    public static void InitializeQuick()
    {
        try
        {
            ...
            Handler.ControlAxis(new Handler.Axis() { name = "Pitch", positiveButton = "s", negativeButton = "w", altPositiveButton = "down", altNegativeButton = "up", gravity = 0.3f, sensitivity = 0.7f, type = 0, dead = 0.001f, descriptiveName = "Key 35" }, false);
